...
ggplot(plot, aes(x=V1,y = V2)) +
    ...
    geom_line(aes(x = V1, y = V4), color = 'green') +
    geom_line(aes(x = V1, y = V5), color = 'green') +
    geom_line(aes(x = V1, y = V6), color = 'blue') +
    geom_line(aes(x = V1, y = V7), color = 'blue') 
...
ggplot(plot, aes(x=V1,y = V2)) +
    ...
    geom_line(aes(x = V1, y = V3), color = 'black') +
    geom_line(aes(x = V1, y = V4), color = 'yellow') +
    geom_line(aes(x = V1, y = V5), color = 'yellow') +
    geom_line(aes(x = V1, y = V6), color = 'purple') +
    geom_line(aes(x = V1, y = V7), color = 'purple') 
```
